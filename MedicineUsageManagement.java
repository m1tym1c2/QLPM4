...
public class MedicineUsageManagement extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        Anhdaidien.setIcon(new javax.swing.ImageIcon(getClass().getResource("/assets/33.png"))); // NOI18N
        jPanel2.add(Anhdaidien, new org.netbeans.lib.awtextra.AbsoluteConstraints(750, 10, 70, 70));

        Tentaikhoan.setFont(new java.awt.Font("Segoe UI", 1, 24)); // NOI18N
        Tentaikhoan.setForeground(new java.awt.Color(0, 84, 42));
        Tentaikhoan.setText("ADMIN");
        jPanel2.add(Tentaikhoan, new org.netbeans.lib.awtextra.AbsoluteConstraints(830, 30, -1, -1));
        ...
        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(690, 90, 280, 180));
        ...
        getContentPane().add(BaoCaoSD, new org.netbeans.lib.awtextra.AbsoluteConstraints(740, 90, 220, 40));
        ...
        getContentPane().add(ThemThuoc, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 90, 200, 40));
